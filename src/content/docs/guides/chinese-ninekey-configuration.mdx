...
1. 更新内置输入方案
    ...
    ![更新内置方案](images/nine-keyboard/01.png)

2. 更新内置键盘皮肤

    点击『键盘皮肤』中右上角『...』菜单，选择『重置内置键盘』，并选择『确认』。

    ![更新内置键盘皮肤](images/nine-keyboard/02.png)

<Aside type="tip">
- 元书应用中内置输入方案为[雾凇拼音](https://github.com/iDvel/rime-ice)；
- 雾凇拼音提供了很多种输入方案，其中包含了全拼(雾凇拼音)，双拼（自然码双拼，微软双拼等等），中文九键等等；
- 雾凇拼音中的不同的输入方案只是配置不同，它们使用的词库都是相同的；
- 元书中文九键功能需要对输入方案做一些特殊配置（具体见下方的「RIME 方案如何配置中文九键」部分），而雾凇拼音中的「中文九键」已经内置的这些配置，所以输入方案需要选择雾凇拼音下的「中文九键」方案；
</Aside>
...
1. 设置中文九键匹配的方案
    ...
    ![设置中文九键方案](images/nine-keyboard/03.png)
...
2. 进入皮肤页面，选择『T9』皮肤。
    ...
    ![选择 T9 皮肤](images/nine-keyboard/04.png)

## RIME 方案如何配置中文九键

<Aside title="注意" type="tip">
- 如果您使用的是雾凇输入方案或应用内置方案，无需配置，按上面的「启用步骤」操作即可。
- 仅支持全拼方案改造，双拼方案不支持
</Aside>
